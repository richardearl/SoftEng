...

	{
...

		{
			...
			case 1:// add contact option.............
				...
				nickName = stringReader.nextLine();
				...
				System.out.println("["+name+","+nickName+","+contactType+","+address+","+dateOfBirth+","+email+","+phoneList+"]");
				totalDetails = name+"="+dateOfBirth+":"+nickName+":"+contactType+":"+address+":"+email+":"+phoneList+":"+new Date();
...

			{
...

				{
					...
					case 2:
						...
						newnickName = stringReader.nextLine();
						break;
					...
					case 7: System.out.println("["+editName+","+newnickName+","+newContactType+","+newAddress+","+newDob+","+newEmail+","+newPhone+"]");
					String newDetails = editName+"="+newDob+":"+newnickName+":"+newContactType+":"+newAddress+":"+newEmail+":"+newPhone+":"+new Date();
			...
			//dob:nickName:tag:address:email1,email2,email3..:ph1,ph2,...:crtdate
			break;
			...
			case 5:
				...
				ArrayList nickNameMatchList = new ArrayList();
				String addedString = "";
...

				{
					...
					addedString = "";
					//System.out.println("name = "+name+" dateOfbirth = "+dateOfBirth+" nickName ="+nickName+" contactType ="+contactType+"address ="+address+"email ="+email+"phoneList ="+phoneList);

					if(name.contains(searchString))


					{
						addedString = "<"+name+" --> "+dateOfBirth+" - "+nickName+" - "+contactType+" - "+address+" - "+email+" - "+phoneList+">";
					...
					{
						addedString = "<"+dateOfBirth+" --> "+name+" - "+nickName+" - "+contactType+" - "+address+" - "+email+" - "+phoneList+">";
						dobMatchList.add(addedString);
					}

					if(nickName.contains(searchString))


					{
						addedString = "<"+nickName+" --> "+name+" - "+dateOfBirth+" - "+contactType+" - "+address+" - "+email+" - "+phoneList+">";
						nickNameMatchList.add(addedString);
					}
					...
					{
						addedString = "<"+contactType+" --> "+name+" - "+dateOfBirth+" - "+nickName+" - "+address+" - "+email+" - "+phoneList+">";
					...
					{
						addedString = "<"+address+" --> "+name+" - "+dateOfBirth+" - "+contactType+" - "+nickName+" - "+email+" - "+phoneList+">";
					...
					{
						addedString = "<"+email+" --> "+name+" - "+dateOfBirth+" - "+contactType+" - "+nickName+" - "+address+" - "+phoneList+">";
					...
					{
						addedString = "<"+phoneList+" --> "+name+" - "+dateOfBirth+" - "+contactType+" - "+nickName+" - "+address+" - "+email+">";
						phoneMatchList.add(addedString);
					}

				}
				System.out.println("\n<TOTAL NUMBER OF MATCHES = "+(nameMatchList.size()+dobMatchList.size()+nickNameMatchList.size()+tagMatchList.size()+addressMatchList.size()+emailMatchList.size()+phoneMatchList.size()+">"));
				...
				if(!nickNameMatchList.isEmpty())


				{
					System.out.println("\nTOTAL NUMBER OF PET NAMES THAT MATCH WITH THE SEARCH STRING "+searchString+" = "+nickNameMatchList.size()+"\n");
					System.out.println("\nTHE PET NAMES OF THE FOLLOWING CONTACTS MATCHES WITH THE SEARCH STRING ");
					System.out.println("--------------------------------------------------------------------------------\n");

					for(Object o: nickNameMatchList)
